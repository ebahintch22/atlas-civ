           ...
           _log : function(message){
            ...
            addLog : function(message , result= "" ){
                var style = (result == "success")?
                            ...
                            `style = "font-weight: regular; color: white;"`;

                var tmpl = `<div ${style}><span> ${dateFormat(Date.now())} : </span><span> ${message}</span> </div>`
	    ...
	    <div id="${Cfg.id}"  class="card">
			...
			<nav>
			  <div class="nav nav-tabs" id="_nav-tab" role="tablist">
				{{#tabs}}
					<a class="nav-item nav-link {{active}}" id="{{id}}-tab" data-toggle="tab" data-tabname="{{name}}" data-tablabel="{{label}}"  href="#{{id}}" role="tab" 
...
function init_helper_functions(){
	...
	include_button_input = function(eltID , btnCaption , placeHolder){
		return(
			`
			<nav class="navbar navbar-light bg-light">
			  <form id="${eltID}" class="form-inline" onSubmit="submit_function(this , '${eltID}')">
	...
	include_button = function(eltID , btnCaption ){
		return(
			`
			<nav class="navbar navbar-light bg-light">
			  <form id="${eltID}" class="form-inline" onSubmit="submit_function(this , '${eltID}')">
