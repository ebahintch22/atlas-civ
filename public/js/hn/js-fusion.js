		   ...
		   tabs : [
			{
				...
				html_content :  `${ get_chart_container( "covid-canvas-up-1" , 650, 300 ,'95%', '25vh')}`,
				enabled : true
			}, 
			{
				id : "covid-tab-up-02",
				...
				html_content : `${ get_chart_container( "covid-canvas-up-2" , 650, 300 ,'95%', '25vh')}`,
				enabled : true
			},
			{ 
				id: "covid-tab-up-03", 
				...
				html_content : `${ get_chart_container( "covid-canvas-up-3" , 650, 300 ,'95%', '25vh')}`,
				enabled : true
			}
		]
	},
...
var navtabController_COVID_BOTTOM =  new ui_render_navtabs (
	  ...
	  nav_position : "bottom",
       	      tabs : [
				{
					...
					html_content :  `${get_chart_container( "covid-canvas-bottom-1" , 650, 300 ,'95%', '25vh')}`,
					enabled : true
				}, 
				{
					...
					html_content : `${get_chart_container( "covid-canvas-bottom-2" , 650, 300 ,'95%', '25vh')}`,
					enabled : true
				},
				{ 
					...
					html_content : `${get_chart_container( "covid-canvas-bottom-3" , 650, 300 ,'95%', '25vh')}`,
					enabled : true
				}
			]
		},
    ...
    function _start_session(){
		...
		if (storeAgent.existItem("opera.kassaprekoh.2020" , byPassKey)){
			...
			exec_infinite_safe(function(){	
				Ajaxian.read( `./visitors/read_visitor/${user_key}`, restoreUserBadge, unexpected_Error_handler)
				loop_counter++;
